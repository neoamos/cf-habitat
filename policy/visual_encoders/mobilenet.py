...
def make_mobilenet_v2(pretrained: bool = False, progress: bool = True, **kwargs: Any) -> MobileNetV2:
    """
...
def mobilenet_v2(in_channels, base_planes, ngroups):
  model = make_mobilenet_v2(pretrained=True)
